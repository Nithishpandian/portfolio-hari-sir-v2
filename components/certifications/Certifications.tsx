  ...
  return (
    <div className="relative pt-36 pb-20 xl:pt-44 xl:pb-24 overflow-hidden px-8">
      ...
      <div className="absolute top-20 left-0 w-[120%] -ml-[10%] z-30">
        <div className="w-full bg-[#acd800] py-2 lg:py-4 transform -rotate-3 md:-rotate-2 overflow-hidden opacity-80">
      ...
      <div className="absolute top-20 left-0 w-[120%] -ml-[10%]">
        <div className="w-full bg-[#252525] py-7 lg:py-8 transform rotate-5 md:rotate-4 overflow-hidden "></div>
      </div>
